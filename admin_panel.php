...
if (isset($_POST['action'])) {
    switch ($_POST['action']) {
        case 'add':
            ...
            $query = "INSERT INTO food (name, id_category, price, weight, description) 
                      VALUES ('$name', '$category', '$price', '$weight', '$description')";
...
<body>
    ...
    <script>
        ...
        function openEditModal(id, categoryId, name, price, weight, description) {
